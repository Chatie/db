...
> {
  ...
  public async create(newBotie: {
    ...
    log.verbose('BotieStore', 'add(newBotie{name=%s})', newBotie.name)
    ...
    const mutationResult: CreateBotieMutation = await this.db.apollo.mutate<CreateBotieMutation>({
      ...
      variables,
      update: this.mutateUpdateFn(_ModelMutationType.CREATED, 'createBotie'),
    }).then(m => m.data)
  ...
  public async delete(id: string): Promise< Partial<Botie> > {
    ...
    const result: DeleteBotieMutation = await this.db.apollo.mutate<DeleteBotieMutation>({
      ...
      variables,
      update: this.mutateUpdateFn(_ModelMutationType.DELETED, 'deleteBotie'),
    }).then(m => m.data)
  ...
  public async update(id: string, props: Partial<Botie>): Promise<Botie> {
    ...
    const result: UpdateBotieMutation = await this.db.apollo.mutate<UpdateBotieMutation>({
      ...
      variables,
      update: this.mutateUpdateFn(_ModelMutationType.UPDATED, 'updateBotie'),
    }).then(m => m.data)
